...
public class Listita extends AppCompatActivity {
    ...
    private int []imagen = { R.drawable.mapita,R.drawable.editar,R.drawable.borrar };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            DbCuenta dbCuenta = new DbCuenta(Listita.this);
            String completoTextoU = myInfoBD.verInfo(numArchivo);
            MyInfo datosU = json.leerJson(completoTextoU);

            textView.setText("Cuentas de " + datosU.getNombre());
    ...
    private void toast1( int i )
    {
        int numArchivo = getIntent().getExtras().getInt("numArchivo");
        int numLista = getIntent().getExtras().getInt("numLista");
        Intent intent = new Intent (Listita.this, MapList.class);
        intent.putExtra("numArchivo", numArchivo);
    ...
    private void toast2( int i )
    {
        int numArchivo = getIntent().getExtras().getInt("numArchivo");
        int numLista = getIntent().getExtras().getInt("numLista");
        Intent intent = new Intent (Listita.this, EditList.class);
        intent.putExtra("numArchivo", numArchivo);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.MenuCerrarSesionrId:
                Intent intent1 = new Intent (Listita.this, Login.class);
                startActivity( intent1 );
                break;
            case R.id.LlevarA:
                int numArchivo1 = getIntent().getExtras().getInt("numArchivo");
                Intent intent2 = new Intent (Listita.this, MainActivity2.class);
            ...
            case R.id.MenuNuevoId:
                ...
                Intent intent3 = new Intent (Listita.this, EditList.class);
    ...
    public void Regresar (View v){
        int numArchivo = getIntent().getExtras().getInt("numArchivo");
        int numLista = getIntent().getExtras().getInt("numLista");
        Intent intent = new Intent (Listita.this, Login.class);
        intent.putExtra("numArchivo", numArchivo);
        intent.putExtra("numLista", numLista);
        startActivity( intent );
    }
